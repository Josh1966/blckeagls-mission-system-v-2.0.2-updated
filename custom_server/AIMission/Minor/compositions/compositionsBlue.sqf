...
_default = [
	[
		"A group of AI was sighted ! Check the Blue marker on your map for the location!",
...
[
	[
		"An AI resupply camp has been spotted. Check the Blue marker on your map for its location",
...
[
	[
		"An AI camp has been spotted. Check the Blue marker on your map for its location",
		"The AI camp at the Blue marker is under player control"
	],
	[
...
[
	[
		"An AI Meidcal camp has been spotted. Check the Blue marker on your map for its location",
