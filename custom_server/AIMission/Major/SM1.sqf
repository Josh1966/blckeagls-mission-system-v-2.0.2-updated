...
// Variables here are [_crate, _lootArray, num weapons to add, num items from the magazines array to add, num items from the item array to add]
...
for "_i" from 1 to blck_AIGrps_Major do {
	...
	_aiGroup = [_newPos,_numAIGrp,_numAIGrp+1,blck_WeaponList_Major,blck_SpawnVeh_Major, blck_SkillsBlack] call blck_spawnGroup;
