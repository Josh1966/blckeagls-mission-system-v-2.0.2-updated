...
_default = [
	[
		"A group of AI was sighted ! Check the Green marker on your map for the location!",
...
_resupplyCamp = [
	[
		"An AI resupply camp has been spotted. Check the Green marker on your map for its location",
...
_redCamp = [
	[
		"An AI Red camp has been spotted. Check the Green marker on your map for its location",
...
_medicalCamp = [
	[
		"An AI Medical camp has been spotted. Check the Green marker on your map for its location",
