...
*/
	...
	***********************************************************/
	...
	blck_reinforcementsOrange = [0,5,0,0];  // Chance of reinforcements, number of reinforcements, chance of armed helipatrol, chance of dropping supplies for the reinforcements
	blck_reinforcementsGreen = [0,4,0,0];
	blck_reinforcementsRed = [0.99,3,0,0.99];
	blck_reinforcementsBlue = [0.99, 3, 0, 0.99];
